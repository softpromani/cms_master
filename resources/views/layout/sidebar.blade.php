        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="shield"></i><span
                ...
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{route('role')}}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                data-i18n="Roles">Roles</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{route('permission')}}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="shield"></i><span
                        class="menu-title text-truncate" data-i18n="portal &amp; manage">Portal</span></a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{route('portal')}}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                data-i18n="portal">Create Portal</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{route('portal.manage')}}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                data-i18n="manage">Manage Portal</span></a>
                    </li>
                </ul>
            </li>
        </ul>
